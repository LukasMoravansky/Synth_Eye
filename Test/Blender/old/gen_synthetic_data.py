...
def main():
    ...
    material_info_b_box = Material_Cls.Random('Area_Testing_Mat', list(Parameters.Scene.Basler_Cam_Str.Resolution.values()),
                                              obj_center_px, bpy.data.objects[Object_Cls.Name].rotation_euler.z)
    ...
    if np.abs(bpy.data.objects[Object_Cls.Name].rotation_euler.y) < Mathematics.CONST_MATH_HALF_PI:
