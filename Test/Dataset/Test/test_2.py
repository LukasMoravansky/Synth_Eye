...
def main():
    ...
    image_data = cv2.imread(f'{project_folder}/Evaluation/Dataset/Image_Res_026_Cropped.png')
    # Load a label (annotation) from a file.
    label_data = File_IO.Load(f'{project_folder}/Evaluation/Dataset/Image_Res_026_Cropped', 'txt', ' ')
    ...
    cv2.imwrite(f'Image_Res_026_Cropped_BB.png', image_data)
