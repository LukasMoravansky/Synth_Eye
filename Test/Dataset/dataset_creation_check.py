...
def main():
    ...
    image_data = cv2.imread(f'{project_folder}/Data/Dataset_v2/images/train/Image_{CONST_INIT_INDEX:03}.png')
    # Load a label (annotation) from a file.
    label_data = File_IO.Load(f'{project_folder}/Data/Dataset_v2/labels/train/Image_{CONST_INIT_INDEX:03}', 'txt', ' ')
