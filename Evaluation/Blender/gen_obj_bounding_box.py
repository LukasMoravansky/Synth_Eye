...
def main():
    ...
    Description:
        ...
        Find and display the main bounding box parameters relevant to the main object structure.
            Object_Parameters_Str() in ../Parameters/Object.py
    """
    ...
    for obj in bpy.data.objects:
        ...
        Blender.Utilities.Set_Object_Transformation(obj.name, T_0)
        ...
        (min_verts, max_verts) = Utilities.General.Get_Min_Max(np.array(Blender.Utilities.Get_Vertices_From_Object(obj.name), dtype=np.float64))
        ...
        Blender.Utilities.Create_Primitive('Cube', f'{obj.name}_Bounding_Box', box_properties)
        ...
        Blender.Utilities.Set_Object_Origin(f'{obj.name}_Bounding_Box', (-1) * origin)
        
        # Reset the position and rotation of the object (bounding box) in the scene.
        Blender.Utilities.Set_Object_Transformation(f'{obj.name}_Bounding_Box', T_0)
