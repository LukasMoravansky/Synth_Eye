...
def main():
    ...
    image_data = cv2.imread(f'{project_folder}/Data/Dataset_v1/images/train/Image_{idx:03}.png')
    
    # Function to adjust the contrast and brightness parameters of the input image 
    # by clipping the histogram.
    (alpha_custom, beta_custom) = Utilities.Image_Processing.Get_Alpha_Beta_Parameters(image_data, 0.5)  
    ...
    cv2.imwrite('Test_100_Old.png', image_data)
    cv2.imwrite('Test_100_New.png', image_out)
